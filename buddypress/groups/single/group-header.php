...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php esc_html_e( 'Group Mods' , 'redart' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( esc_html__( 'active %s', 'redart' ), bp_get_group_last_active() ); ?></span>
	...
	<h3><?php esc_html_e( 'Group Admins', 'redart' ); ?></h3>
