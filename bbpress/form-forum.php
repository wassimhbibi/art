				...
				<legend>
					...
					<?php
						if ( bbp_is_forum_edit() )
							printf( esc_html__( 'Now Editing &ldquo;%s&rdquo;', 'redart' ), bbp_get_forum_title() );
						else
							bbp_is_single_forum() ? printf( esc_html__( 'Create New Forum in &ldquo;%s&rdquo;', 'redart' ), bbp_get_forum_title() ) : esc_html_e( 'Create New Forum', 'redart' );
					?>
...
<?php elseif ( bbp_is_forum_closed() ) : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php printf( esc_html__( 'The forum &#8216;%s&#8217; is closed to new content.', 'redart' ), bbp_get_forum_title() ); ?></p>
		</div>
	</div>
